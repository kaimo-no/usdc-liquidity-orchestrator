...
var chainRegistry = []ChainInfo{
	{
		...
		USDC: "0x3600000000000000000000000000000000000000", GatewayOK: true, CCTPOK: true,
	},
	{
		CAIP2: "eip155:84532", Name: "base-sepolia", GatewayDomain: 6,
		USDC: "0x036CbD53842c5426634e7929541eC2318f3dCF7e", GatewayOK: true, CCTPOK: true,
	},
	{
		CAIP2: "eip155:421614", Name: "arbitrum-sepolia", GatewayDomain: 3,
		USDC: "0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d", GatewayOK: true, CCTPOK: true,
	},
	{
		CAIP2: "eip155:8453", Name: "base", GatewayDomain: 6,
		USDC: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", GatewayOK: true, CCTPOK: true,
	},
	{
		CAIP2: "eip155:42161", Name: "arbitrum", GatewayDomain: 3,
		USDC: "0xaf88d065e77c8cC2239327C5EDb3A432268e5831", GatewayOK: true, CCTPOK: true,
	},
}
